...
def upgrade() -> None:
    ...
    op.alter_column("observation", "event_id", existing_type=sa.INTEGER(), nullable=False)
...
def downgrade() -> None:
    ...
    op.alter_column("observation", "event_id", existing_type=sa.INTEGER(), nullable=True)
    op.add_column(
        "event",
