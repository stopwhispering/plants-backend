...
def create_db_engine(connection_string: URL) -> AsyncEngine:
    ...
    It maintains a <<pool of connections>>. Connection is the thing that
    actually does the work of executing a SQL query. With the
    connection, you could run several different SQL statements and
