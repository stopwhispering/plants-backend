...
def _disassemble_taxon_name(botanical_name_input: BotanicalNameInput) -> list[PartOfBotanicalName]:
    assert botanical_name_input.genus

    genus_name = (botanical_name_input.genus if not botanical_name_input.hybridgenus
    ...
    if botanical_name_input.species:
        species = (botanical_name_input.species if
                   not botanical_name_input.hybrid
                   or botanical_name_input.hybridgenus else '× ' + botanical_name_input.species)
    ...
    if botanical_name_input.custom_infraspecies:
        if botanical_name_input.custom_rank == FBRank.SUBSPECIES.value:
            parts.append(PartOfBotanicalName(name='ssp.', italics=False))
            parts.append(PartOfBotanicalName(name=botanical_name_input.custom_infraspecies, italics=True))
    ...
    if botanical_name_input.cultivar:
        ...
        parts.append(PartOfBotanicalName(name="'" + botanical_name_input.cultivar + "'", italics=False))
...
def _create_publication_parts(botanical_name_input: BotanicalNameInput | None) -> list[PartOfBotanicalName]:
    ...
    if botanical_name_input.name_published_in_year:
        publication_parts.append(PartOfBotanicalName(
            name=" (" + str(botanical_name_input.name_published_in_year) + ")",
            italics=False))
    return publication_parts


def create_formatted_botanical_name(botanical_attributes: Taxon | BotanicalNameInput,
