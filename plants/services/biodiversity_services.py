...
#     FRetrieveTaxonDetailsRequest, BSearchResultSource
# )
...
#
#
# def retrieve_taxon_details(retrieve_taxon_details_request: FRetrieveTaxonDetailsRequest, db: Session) -> Taxon:
#     taxon = None
#
