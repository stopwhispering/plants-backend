...
from plants_tagger.services.os_paths import REL_PATH_PHOTOS_GENERATED, REL_PATH_PHOTOS_ORIGINAL
from plants_tagger.util.exif_utils import auto_rotate_jpeg, decode_keywords_tag, decode_record_date_time, \
