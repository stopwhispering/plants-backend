...
from flask_2_ui5_py import throw_exception, MessageType

from plants_tagger.models import get_sql_session
from plants_tagger.models.orm_tables import Plant, Taxon, PropertyName, PropertyValueTaxon, PropertyValuePlant
...
def get_add_property_name(property_name: str, category_id: int):
    ...
    for c in categories:
        ...
        for n in names_category:
            ...
            for v in values_name:
                ...
                # todo: make sure there's only one property value for both plant and taxon in db
