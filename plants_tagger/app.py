...
from plants_tagger.resources.species_database_resource import SpeciesDatabaseResource
...
def create_app():
    ...
    api.add_resource(SpeciesDatabaseResource, '/plants_tagger/backend/SpeciesDatabase')
